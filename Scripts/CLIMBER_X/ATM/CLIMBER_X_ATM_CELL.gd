...
var fax : Array[float] = []
var faxo : Array[float] = []
var fay : Array[float] = []
var fayo : Array[float] = []
var fac : float = 0
var w3 : Array[float] = []

var conv_energy : float = 0
var conv_water : float = 0
var conv_dust : float = 0
var conv_co2 : float = 0
var fa_energy : float = 0
var fa_water : float = 0
var fa_dust : float = 0
var fa_co2 : float = 0
var fd_energy : float = 0
var fd_water : float = 0
var fd_dust : float = 0
var fd_co2 : float = 0 
